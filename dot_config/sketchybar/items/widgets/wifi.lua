...
local wifi_up_graph = sbar.add("graph", "widgets.wifi1_graph", 32, {
	position = "right",
	align = "right",
	graph = {
		color = colors.tn_red,
...
local wifi_down_graph = sbar.add("graph", "widgets.wifi2_graph", 32, {
	position = "right",
	graph = {
...
local wifi_bracket = sbar.add("bracket", "widgets.wifi.bracket", {
	...
	background = { color = colors.tn_black3, border_color = colors.tn_magenta, border_width = 1 },
	popup = {
		align = "center",
		height = 26,
		background = { color = colors.tn_black3, border_color = colors.tn_magenta, border_width = 1 },
